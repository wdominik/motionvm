...
| 5 | 178 | **The game library** — see [Game library](../library/game-library.md): verbs, records, hit testing, inventory, task machine, `INCLLOC`, [text/speech](../library/text-and-speech.md), [walking](walking.md), the [GT animator](../library/animation.md) |
...
| 9, 19 | 13 | The **Karsten** walk set — see [Walking](walking.md); module 19 is a byte-identical copy of 9 (same source at a different load base), and module 212 embeds a third |
...
order. See [Savegames](savegames.md) and [Shell](../library/shell.md).
...
- [Blocks](../formats/block.md) — the parallel per-location data blocks

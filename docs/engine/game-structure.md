...
(module 2); the native loop consumes it (see [Game loop](game-loop.md)).
...
[Descriptors](descriptors.md)). After the scene is built, `?SLDONE` story
...
formats in [Savegames](savegames.md).
...
- [Module map](module-map.md)
- [Game loop](game-loop.md)
- [Screens](screens.md), [Descriptors](descriptors.md)
- [Blocks](../formats/block.md) — the location table and data records

...
[Text rendering](../engine/text-rendering.md); the sample playback layer
is in [Audio](../engine/audio.md).
...
- `SPEECHSEQ-> ( -- 0 | handle )` — poll the running speech sample
  ...
  [speech pump](../engine/audio.md).

The full pump logic and why the system is dead in the shipped game are
described under [Audio](../engine/audio.md).

## See also

- [Text rendering](../engine/text-rendering.md) — measurement, backing,

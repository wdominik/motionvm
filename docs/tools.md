...
*The shipped command-line tool, across both generations of the engine. It reads a game's containers and writes out what it finds; what those containers are is documented under [MOTION 32-bit](README.md#motion-32-bit) and [MOTION 16-bit](README.md#motion-16-bit).*

`motionvm-tools` reads a game's containers and writes what it finds as ordinary
...
The examples below abbreviate that invocation to `motionvm-tools`, and their

...
| 600 | 800–870 | 71 | 1760 | **Core helpers** — the small integers as constants (0–20, the even numbers to 30, −1, 100, 1000), store and arithmetic shorthands (`+@`, `+!`, `0!`, `1+`, `2*`, `DUP0`…`DUP6`, `++`, `--`, `==>`, `,,`), and the descriptor builders `XYLSITEM.`, `XYLBITEM.`, `NEWTEXT.`. Word for word Die Enviro-Kids greifen ein's module 600 |
...
Die Enviro-Kids greifen ein has 615, this game has nothing.

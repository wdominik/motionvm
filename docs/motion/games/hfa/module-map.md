...
| 601 | 900–1014 | 115 | 5554 | **The game's state** — `STARTLOC`, `LASTLOC`, `ACTLOC`, `NEXTLOC`, the `_LOCLINK` map, `_LOADTABLE`, and the table constants `A_LDITEM` 35, `S_LDITEM` 32, `A_FITEM` 50, `S_FITEM` 10. The location variables a boot or a location change moves through are these |

...
The same selection is made in the rebuild, by different mechanics — a
[departure](../../departures.md#display-and-timing).
...
- [Departures](../../departures.md#display-and-timing) — how the rebuild runs
  this pass, and the `SDAUTOBUF` copy it does not keep

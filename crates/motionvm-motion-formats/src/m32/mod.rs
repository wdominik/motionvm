//! Readers for the formats of the 32-bit MOTION engine, in both shipped
//! builds of `ENGINE.EXE`: V0.04.15/R78 as Checker 2000 ships it and
//! V0.06.06/R109 as "Im Netzwerk gefangen - Dunkle Schatten 2" does.
//!
...
//! script modules, HMI songs, WAV samples, Ad Lib banks, driver archives and
//! the LE binary the kernel table is lifted from. What both generations share — palettes,
...
pub use rsc::{Bank, Kind, Rsc, has_container, is_container_name};

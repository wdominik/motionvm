...
use motionvm_engine::{Descriptor, Game, titles};
...
fn the_six_intro_pages_read_table_16_in_order() {
    ...
    let container = motionvm_formats::m16::Container::open_dir(&dir).expect("the container");
    let table = motionvm_formats::m16::text::parse(
        container
            .item(motionvm_formats::m16::Segment::Txt, 16)

...
//!
//! `motionvm-motion-formats` has a file of this shape already, and its header says
...
//! `motionvm_motion_engine::Error::Data` puts the path in front of them. Written the
...
//! point: like `motionvm-motion-formats`' file, this one runs everywhere, and CI's

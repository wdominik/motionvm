...
//! taken from Die Enviro-Kids greifen ein would still bind — and would run this bytecode
...
fn run_executes_on_this_machine_up_to_the_first_engine_word() {
    ...
    // The same boot shape as Die Enviro-Kids greifen ein's, module for module: the

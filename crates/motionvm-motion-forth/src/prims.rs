...
/// [`motionvm_motion_formats::Inline`] set — and only what is left over is looked up
...
mod tests {
    use super::*;
    use crate::m32::IMPLEMENTED;
    use motionvm_motion_formats::m32::le::{INLINE, inline};
    ...
    /// [`INLINE`] and the inline constants, which are the real ones.

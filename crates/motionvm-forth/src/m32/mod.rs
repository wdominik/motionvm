...
use motionvm_formats::m32::le::{KernelWord, TAG_KERNEL};
...
impl Vm {
    ...
    pub fn new(kernel: &[KernelWord]) -> Self {
        Self::with_binding(&motionvm_formats::m32::le::binding_of(kernel))
    }

    /// A machine over an already bound kernel.
    pub fn with_binding(binding: &motionvm_formats::Binding) -> Self {

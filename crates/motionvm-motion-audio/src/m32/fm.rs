...
//!
//! `HMIMDRV.386` holds eight MIDI drivers (see [`motionvm_motion_formats::m32::drv`]); the one
...
//! MIDI messages the [sequencer](crate::m32::sequencer) produces and answers with
